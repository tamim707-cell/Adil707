...
يعرض كلا الملفين **لوحة معلومات** على الشارت (قابلة للإظهار/الإخفاء وتغيير موضعها):

- **حالة QQE Mod** (أخضر/أحمر/محايد).
- **حالة Ultimate MA** (أخضر/أحمر).
- **الاتجاه العام** (صاعد/هابط).
- **في الاستراتيجية**: الصفقة الحالية + **صافي الربح** + **نسبة الفوز** + **عدد الصفقات** (إحصائيات الأداء من الـ Backtest).
- **في المؤشر**: حالة الإشارة الحالية (داخل صفقة / بانتظار).
